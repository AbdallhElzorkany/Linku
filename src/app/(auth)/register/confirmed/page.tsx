        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 text-center">
          <div className="relative w-24 h-24 mx-auto mb-8">
            ...
            <div className="relative w-24 h-24 bg-linear-to-br from-neutral-100 to-gray-100 rounded-full flex items-center justify-center">
              <CheckCircle className="w-12 h-12 text-neutral-600" />
            </div>
          </div>
          ...
          <div className="bg-linear-to-r from-neutral-50 to-gray-50 border-2 border-neutral-200/50 rounded-2xl p-5 mb-8">
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-neutral-600 mt-0.5 shrink-0" />
              <div className="text-sm text-left">
                <p className="text-neutral-900 mb-2">You&apos;re all set!</p>
          ...
          <div className="border-t border-gray-200 pt-6 mt-6">
            <Link
              href="/get-started"
              className="inline-flex items-center justify-center gap-2 w-full py-3.5 bg-neutral-800 text-white rounded-xl hover:shadow-lg hover:shadow-neutral-500/30 transition-all hover:scale-[1.02] group mb-4"
            >
