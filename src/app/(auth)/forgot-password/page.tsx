      ...
      <div className="min-h-screen bg-linear-to-br from-neutral-50 via-gray-50 to-white flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 text-center">
            ...
            <Link
              href="/login"
              className="block w-full py-3.5 bg-neutral-800 text-white rounded-xl hover:shadow-lg hover:shadow-neutral-500/30 transition-all hover:scale-[1.02]"
            >
              Back to Login
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-linear-to-br from-neutral-50 via-gray-50 to-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100">
          ...
          <h1 className="text-4xl mb-3 text-center">Forgot password</h1>
          ...
          <Form action={action} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-neutral-800 text-white rounded-xl hover:shadow-lg hover:shadow-neutral-500/30 transition-all hover:scale-[1.02]"
              disabled={isPending}
            >
              {isPending ? (
